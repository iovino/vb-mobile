<!-- navigation menus -->
<nav id="menu-left" class="mmm-current mmm-opened">
    <div class="my-account-content">
        <div class="avatar-box">
            <div class="avatar-img">
                <img src="http://avatar.coolclip.ru/albums/Avatars/Avatars%2080x80/Avatars_80x80_028.jpg" alt=""/>
            </div>
            <ul>
                <li class="username"><a href="">Ken Iovino</a></li>
                <li class="usertitle">Pro</li>
            </ul>
        </div>
